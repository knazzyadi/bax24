...
interface LocationSelectorProps {
  location: {
    ...
    handleRoomChange: (id: string) => void;
  };
  isRtl: boolean;
}

export function LocationSelector({ location, isRtl }: LocationSelectorProps) {
  // استخراج كل القيم من location مرة واحدة
  const {
    buildings,
    floors,
    rooms,
