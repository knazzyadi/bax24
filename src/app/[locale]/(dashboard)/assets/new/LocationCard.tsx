...
import { MapPin, Building as BuildingIcon, Layers, DoorOpen, Settings } from "lucide-react";
import type { Building, Floor, Room, Branch, AssetType, AssetStatus } from "@/types/assets";
        ...
        <div className="pt-4 border-t border-slate-200/50 dark:border-slate-800/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Select value={branchId} onValueChange={onBranchChange} disabled={branches.length === 0}>
                <SelectTrigger className="w-full h-12 rounded-xl border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 focus:ring-2 focus:ring-indigo-500/50 transition-all px-4">
