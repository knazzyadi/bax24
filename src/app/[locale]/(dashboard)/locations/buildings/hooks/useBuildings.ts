// src/app/[locale]/(dashboard)/locations/buildings/hooks/useBuildings.ts
...
export function useBuildings(initialBuildings: Building[], initialBranches: Branch[]) {
  ...
  // تحديث القائمة بعد أي تغيير (استدعاء من الخادم)
  ...
  // تطبيق البحث والترتيب والتصفية على المباني
