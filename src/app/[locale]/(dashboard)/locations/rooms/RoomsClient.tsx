...
export default function RoomsClient({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const success = await deleteRoom(confirmDialog.id);
      if (success) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                {isRtl
                  ? 'إدارة الغرف وتنظيمها حسب الأدوار والمباني'
                  : 'Manage rooms and organize by floors and buildings'}
              </p>
            </div>
          </div>
          <Button
