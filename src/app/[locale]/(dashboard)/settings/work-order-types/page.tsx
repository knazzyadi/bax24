// src/app/[locale]/(dashboard)/settings/work-order-types/page.tsx
"use client";
...
import { WorkOrderTypeTable } from "./WorkOrderTypeTable";
...
export default function WorkOrderTypesPage() {
  ...
  const { data: types, loading, refetch } = useSettingsData<WorkOrderType>({
  ...
  const handleConfirmDelete = async () => {
    ...
    setDeleting(true);
    try {
      const res = await fetch(`/api/work-order-types/${confirmDialog.id}`, { method: "DELETE" });
      if (!res.ok) {
