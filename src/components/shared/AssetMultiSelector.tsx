// src/components/shared/AssetMultiSelector.tsx
"use client";
...
// ✅ تم حذف branchId لأنه غير مستخدم
...
export function AssetMultiSelector({
  roomId,
  assetTypeId,
  value,
  onChange,
}: AssetMultiSelectorProps) {
  ...
  const availableAssets = roomId ? assets : [];
