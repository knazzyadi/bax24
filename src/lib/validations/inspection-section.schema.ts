// src/lib/validations/inspection-section.schema.ts
import { z } from "zod";
...
export const CreateInspectionSectionSchema = InspectionSectionSchema.omit({
  id: true,
  companyId: true,
  createdAt: true,
  updatedAt: true,
...
export const UpdateInspectionSectionSchema = CreateInspectionSectionSchema.partial();